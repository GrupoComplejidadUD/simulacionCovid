...
to setup
  ...
  set listaAtributosPersona [ "infectada?" "restante-serInmune" "tiempo-infectado" "coordenadaCasa" "edad" "tiempoPromedioViajeAlTrabajo" "tiempoPromedioViajeACasa" "vehiculoPropio?" "estratoSocial" "nivelEnfermedad"]
...
to get-infeccion
  set infectada? true
  show lugarPosicion
  actualizarLugarInfeccion lugarPosicion
